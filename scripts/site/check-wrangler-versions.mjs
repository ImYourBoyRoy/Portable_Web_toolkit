// ./scripts/site/check-wrangler-versions.mjs
/**
 * Compares installed Wrangler toolchain versions against the npm registry.
 * Copy or reference from Portable_Web_toolkit/scripts/site/ in each Astro site.
 * Run: node ./scripts/check-wrangler-versions.mjs or npm run check:wrangler
 */
